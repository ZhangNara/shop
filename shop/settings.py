...
SECRET_KEY = 'bo4$1abxf#)^z_l1mc#h4(c-!he@ytqun@ib%^5v((2qzlqey7'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'shop',  # 数据库名字
        'USER': 'root',  # 账号
        'PASSWORD': 'Zry951103',  # 密码
        'HOST': '39.98.192.225',  # IP
        'PORT': '3306',  # 端口
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://39.98.192.225:6379",
        "OPTIONS": {
...
SOCIAL_AUTH_WEIBO_KEY = '2729206077'
SOCIAL_AUTH_WEIBO_SECRET = '5c878dcc69bee0f0ed5d3b1bba22d43c'
